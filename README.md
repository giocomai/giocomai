...
- [`castarter`](https://github.com/giocomai/castarter) - Content analysis starter toolkit for R - is a more modern, fully-featured, and consistent iteration of a package dedicated to text mining ([`castarter.legacy`](https://github.com/giocomai/castarter.legacy) - legacy version, still functioning and available). It facilitates text mining and web scraping by taking care of many of the most common file management issues, keeps tracks of download advancement in a local database, facilitates extraction through dedicated convenience functions, and allows for basic exploration of textual corpora through a Shiny interface. It is fit for daily use and it has rich documentation, although more is planned for covering a larger range of use cases.
